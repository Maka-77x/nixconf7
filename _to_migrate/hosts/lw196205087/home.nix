{ config, pkgs, ... }:
{
  ...
  programs = {
    ...
    firefox = {
      ...
      profiles.default = {
        ...
        settings = {
          ...
          "toolkit.telemetry.reportingmimiicy.firstRun" = false;
    ...
    git = {
      ...
      userName = "Michael Parrett";
      userEmail = "mimi99078878+Maka-77x@users.noreply.github.com";
      aliases = {
