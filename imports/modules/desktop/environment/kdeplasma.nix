{ inputs, ... }:
{
  unify.modules.desktop.home = {
    ...
    programs.plasma = {
      enable = true;
      shortcuts = {
        "ActivityManager"."switch-to-activity-181b1250-1bb2-402c-9d6a-29214f2b2c3f" = "none";
        "ActivityManager"."switch-to-activity-b04cdf06-f69b-4426-a388-d784c86899b5" = "none";
        "ActivityManager"."switch-to-activity-c245c079-af1c-41e3-991e-31836544ee97" = "none";
        "ActivityManager"."switch-to-activity-fc6d77d8-56ad-4801-affa-5593a61db5cc" = "none";
        "KDE Keyboard Layout Switcher"."Switch keyboard layout to Belgian" = "none";
        ...
        "KDE Keyboard Layout Switcher"."Switch keyboard layout to French" = "none";
        "KDE Keyboard Layout Switcher"."Switch keyboard layout to French (legacy, alt.)" = "none";
        ...
        "kwin"."FlipSwitchAll" = "none";
        "kwin"."FlipSwitchCurrent" = "none";
      ...
      configFile = {
        ...
        "plasmarc"."Wallpapers"."usersWallpapers" =
          "/home/mimi/Pictures/Backgrounds/Starry Nebula 219.png,/home/mimi/Pictures/Backgrounds/nix-snowflake-wallpaper.svg";
        ...
        "spectaclerc"."ImageSave"."lastImageSaveAsLocation" =
          "file:///home/mimi/Code/salsa/reproducible-website/images/reports/2024-09/Screenshot_20241002_111646.png";
